---
title: CS 381 -- Homework #1
---

# Homework #1

**Due: Tues, Jun 28, 15:59**

<div class="bold-code">

## How to Submit

You should produce a single file, named `HW1.<your-username>.hs`. This file *must compile without errors* in GHCi. Put all non-working parts of your solution in comments! If your file does not compile, **it will not be evaluated**.
