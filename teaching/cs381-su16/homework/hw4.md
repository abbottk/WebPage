...
In this assignment we will be extending the stack language from [Homework #3](hw3.html). The grammar for the language is defined by the following Haskell type definitions.
...
This stack also manipulates an implicit stack of integers. A program is a sequence of commands, where each command modifies the stack (descriptions of the previously defined operations can be found in [Homework #3](hw3.html)).
